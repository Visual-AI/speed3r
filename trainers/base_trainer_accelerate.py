...
class BaseTrainer:
    ...
    def train(self):
        ...
        for epoch in range(self.first_epoch, self.cfg.train.num_epoch):
            ...
            # # Perform validation at the end of each epoch, commented out due to OOM
    ...
    def train_one_epoch(self, epoch):
        ...
        for it, batch in enumerate(metric_logger.log_every(
            ...
            if it >= self.iters_per_epoch*self.cfg.train.gradient_accumulation_steps:
                break
    ...
    def auto_resume(self):
        ...
        if path is None:
            ...
            start_epoch = int(path.split("checkpoint_")[-1]) + 1
